...
.bgImage 
{
    background-image: url(images/Cover-image-5-scaled.webp);
    ...
    <nav class="navbar" >
        <div class="container">
            ...
            <li><a href = "Stu_details.php"><strong>Student Details</strong></a></li>
                    ...
                    <li class="btnlogout"><a class = "btn btn-default navbar-btn" href = "login_form.php">Logout <span class = "glyphicon glyphicon-log-out"></span></a></li>            
